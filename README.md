...
<h3 align="center">Frontend Developer | UI/UX Enthusiast | Creative Builder 🚀</h3>

---

### 📌 About Me
- 💡 Passionate about crafting **beautiful, modern web experiences**.  
- 🎯 Currently building an **AI-powered Virtual Wardrobe** with 3D previews & smart recommendations.  
- 🌱 Learning **advanced animations** with Framer Motion + React Three Fiber.  
- 💬 Ask me about **JavaScript, React, Next.js, Tailwind, Firebase, UI/UX Design**.  
- ⚡ Fun fact: *I see CSS bugs as design opportunities 😉*  
...
![Shadcn](https://img.shields.io/badge/Shadcn_UI-000?style=for-the-badge&logo=radix-ui)  
...
### 🚀 Featured Project
🔗 **Virtual Wardrobe (AI + 3D Preview)**  
*"Your wardrobe. Curated by you, elevated by AI."*  
✨ React + Next.js + Tailwind + Firebase + React Three Fiber  
